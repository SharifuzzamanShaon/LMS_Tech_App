...
import FindClassmate from "./FindClassmate";
...
const MainLounge = () => {
  ...
  return (
    <>
      <div
        className={`w-[22%] 800px:w-[310px] h-fit dark:bg-slate-900 bg-white dark:text-white shadow-sm !important dark:shadow-sm bg-opacity-90 border dark:border-[#ffffff1d] rounded-[5px] shadow-sm mt-[80px] mb-[80px] sticky
      ...
      <div
        className={`ml-8 w-[75%] 800px:w-[310px] h-[800px] dark:bg-slate-900 bg-white dark:text-white shadow-sm !important dark:shadow-sm bg-opacity-90 border dark:border-[#ffffff1d] rounded-[5px] shadow-sm mt-[80px] mb-[80px] sticky
            ${scroll ? "top-[120px]" : "top-[30px]"} left-[30px]`}
      >
        {navigate === 1 && <Welcome />}
        {navigate === 2 && <FindClassmate />}
        {navigate === 3 && <Groups />}
      </div>
    </>
  );
